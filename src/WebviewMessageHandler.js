    ...
    WebViewBridge.onMessage = function (message) {
      ...
      switch(action.type) {
        ...
        case '${actions.updateLink}':
          ...
          break;
        case '${actions.updateFormula}':
          zss_editor.updateFormula(action.data.text, action.data.id);
          break;
        case '${actions.removeFormula}':
          zss_editor.removeFormula(action.data.id);
          break;
        ...
        case '${actions.insertHTML}':
          zss_editor.insertHTML(action.data);
          break;
        case '${actions.insertTable}':
          zss_editor.insertTable(action.data, html);
          break;
        case '${actions.insertTableIOS}':
          zss_editor.insertTableIOS(action.data, html);
          break;
        case '${actions.setContentHTML}':
        ...
        case '${actions.insertData}':
          ...
          break;
        case '${actions.isSelectedNode}':
          zss_editor.isSelectedNode();
          break;
        case '${actions.setEditable}':
          zss_editor.setEditable();
          break;
        case '${actions.notEditable}':
          zss_editor.notEditable();
          break;
        case '${actions.disableMathJaxScript}':
          zss_editor.disableMathJaxScript();
          break;
        case '${actions.enableMathJaxScript}':
          zss_editor.enableMathJaxScript();
          break;
      }
    };
  }
