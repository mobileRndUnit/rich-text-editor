export const actions = {
  ...
  insertTableIOS: 'INSERT_TABLE_IOS',
  insertImageBase64String: 'INSERT_IMAGE_BASE64_STRING',
  focusEditor: 'FOCUS_EDITOR',
  insertData: 'INSERT_DATA',
  isSelectedNode: 'IS_SELECTED_NODE',
  setEditable: 'SET_EDITABLE',
  notEditable: 'NOT_EDITABLE',
  disableMathJaxScript: 'DISABLE_MATHJAX_SCRIPT',
  enableMathJaxScript: 'ENABLE_MATHJAX_SCRIPT',
};
...
export const messages = {
  ...
  FORMULA_TOUCHED: 'FORMULA_TOUCHED'
};
